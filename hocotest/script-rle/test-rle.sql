...
insert into dna_seq values(1,'2023-03-25', (repeat('aaaaaaaaaaaaaaaaaaaabbbbbbbbbbbbbbbbbbbbabcdefghigk',40)),95.5); 
insert into baseline values(1,'2023-03-25', repeat('aaaaaaaaaaaaaaaaaaaabbbbbbbbbbbbbbbbbbbbabcdefghigk',40),95.5); 
insert into baseline_plain values(1,'2023-03-25', repeat('aaaaaaaaaaaaaaaaaaaabbbbbbbbbbbbbbbbbbbbabcdefghigk',40),95.5); 
...
insert into dna_seq_1 values(1,'2023-03-25', hoco_rle(repeat('aaaaaaaaaaaaaaaaaaaabbbbbbbbbbbbbbbbbbbbabcdefghigk',30)),95.5); 

SELECT hoco_de_rle(seq_data) FROM dna_seq_1;
